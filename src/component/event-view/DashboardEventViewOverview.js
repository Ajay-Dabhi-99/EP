              ...
              <div className="flex max-[640px]:flex-col">
                ...
                <div className="w-full lg:w-8/12 lg:pr-5 space-y-7">
                  <div className="p-7 bg-white rounded-md space-y-1 max-[820px]:mr-3">
                    ...
                    <p className="text-quicksilver text-sm font-normal text-justify">
                              ...
                              >
                                <div className="relative group w-[150px] h-[150px] flex rounded-lg justify-center p-2 mx-1 bg-white  overflow-hidden">
                                  ...
                                  <img
                                    ...
                                    className="block absolute top-1/2 left-1/2 -translate-x-1/2 group-hover:-translate-y-1/2 z-30 opacity-0 group-hover:opacity-100 group-hover:scale-125 anim"
                                  />
                                  <span className="box absolute inset-0 block w-full h-full group-hover:bg-[#000000] group-hover:opacity-50 anim"
                                  //  onClick={() => {
                                  //   setPhotoIndex(i)
                                  //   setPreviewPhoto(true);
                                  // }}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="p-7 bg-white rounded-md space-y-1">
                      {company.name === "" ? "No Company Details Found!!!" :
                        <>
                          <h3>{company?.name}</h3>
                          <p className="text-quicksilver text-sm font-normal text-justify">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="p-3.5 xl:p-5 bg-white rounded-md">
                        <div className="flex items-start text-quicksilver font-normal">
                          <p className="text-sm font-normal pl-3 text-justify">
                  ...
                  {/* <!-- Social-Media --> */}
                  {socials?.facebook && socials?.youtube && socials?.twitter && socials?.pinterest && socials?.instagram && socials?.linkedin !== "" ?
                ...
                <div className="w-full lg:w-4/12 lg:pl-5 space-y-7 sticky top-0">
                  ...
                  <div className="calendar inline-block justify-center items-center rounded-md drop-shadow-one bg-white w-full px-6 py-4 max-[820px]:px-3 max-[820px]:ml-1 max-[820px]:py-4">
                    <FullCalendar
