  ...
  return (
    <div className="bg-white rounderd px-7 py-4 max-[600px]:px-4">
          ...
          <div className="flex justify-between max-[600px]:flex-col-reverse">
            ...
            <div className="flex items-center space-x-5 max-[600px]:space-x-3 max-[600px]:justify-between max-[600px]:flex-wrap">
              <div className="flex items-center">
                ...
                &nbsp;
                <svg class="w-5 h-5 tooltip order-4" data-pr-tooltip={intl.formatMessage({ id: "LET USERS KNOW THE AVAILABILITY OF THE ITEM" })}
              ...
              <a href="#"
                ...
                <i className="text-center icon-fill-delete text-xl tooltip" data-pr-tooltip={intl.formatMessage({ id: "DELETE THIS ITEM" })}
                  data-pr-position="top"></i>
              </a>
              <a
                // className="tooltip"
              ...
              >
                <i className="text-center icon-edit text-xl tooltip" data-pr-tooltip={intl.formatMessage({ id: "EDIT YOUR LISTING" })}
                  data-pr-position="top"></i>
              </a>
            </div>
          </div>
      ...
      <Modal isOpen={removeItem}>
        <RemoveItem handleClose={setRemoveItem} data={data} setReload={setReload} />
      </Modal>
      <ToolTips />
    </div>
  );
