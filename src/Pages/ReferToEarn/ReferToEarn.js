        ...
        <div className="p-7 max-[768px]:p-4 bg-white rounded-md">
          <div className="py-3.5 px-5 rounded-lg bg-spiroDiscoBall flex items-center justify-between">
            ...
            <h1 className="text-white">
              <span className="font-normal">{intl.formatMessage({ id: "TOTAL REWARDS EARNED :" })}</span>{" "}
              {profileDetails?.f_coin}<span>{intl.formatMessage({ id: "F-COINS" })}</span>
            </h1>
            <svg
              width="62"
              height="62"
          ...
          <div className="text-center space-y-6 py-8 pb-10 border-b border-gray-200">
            ...
            <span>{intl.formatMessage({ id: "REFER TO YOUR FRIENDS AND EARN" })}</span>
            </p>
